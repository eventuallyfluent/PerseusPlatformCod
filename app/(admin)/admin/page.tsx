  ...
  return (
    <AdminShell title="Admin overview" description="Operational snapshot for Phase 1 modules.">
      ...
      <Card className="space-y-3">
        <h2 className="text-lg font-semibold text-stone-950">Build order status</h2>
        ...
        <Link href="/admin/products" className="text-sm font-medium text-stone-950 underline">
          Add new product
        </Link>
      </Card>
    </AdminShell>
