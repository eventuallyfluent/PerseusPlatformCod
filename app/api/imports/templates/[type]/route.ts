...
const templates: Record<string, string> = {
  ...
  courses:
    "legacy_course_id,slug,legacy_url,title,subtitle,short_description,long_description,learning_outcomes,who_its_for,includes,hero_image_url,sales_video_url,instructor_slug,instructor_name,seo_title,seo_description,status\n",
  lessons:
