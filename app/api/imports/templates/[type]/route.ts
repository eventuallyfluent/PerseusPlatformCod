...
const templates: Record<string, string> = {
  ...
  courses:
    "legacy_course_id,slug,legacy_url,title,subtitle,short_description,long_description,learning_outcomes,who_its_for,includes,hero_image_url,product_image_url,payhip_image_url,image_url,sales_video_url,sales_image_urls,instructor_slug,instructor_name,seo_title,seo_description,status,price,price_text,offer_options,currency,compare_at_price\n",
  lessons:
