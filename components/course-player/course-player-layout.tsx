            ...
            <div className="space-y-6">
              ...
              {!publicPreview ? (
                <form action={markLessonCompleteAction} className="pt-1 pb-3">
                  ...
                  <button
                    className="inline-flex w-full max-w-xs items-center justify-center rounded-full bg-[var(--button-primary-background)] px-6 py-4 text-sm font-semibold text-white shadow-[var(--button-primary-shadow)] transition hover:bg-[var(--button-primary-hover)] disabled:cursor-not-allowed disabled:opacity-60"
                    type="submit"
